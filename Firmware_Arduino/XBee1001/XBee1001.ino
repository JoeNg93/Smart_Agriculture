...
// #include <OneWire.h> //Library for DS18S20
// #include <DallasTemperature.h> //Library for DS18S20
...
/* Define part for DS18S20 */
#define DS18S20 0x10
#define DS18B20 0x28
#define ReadScratchPad 0xBE
#define ConversionProcess 0x44
#define ConvertToTemp 0.0625
#define DS18S20_PIN 7 //DS18S20 Signal pin on digital 7
//Red wire - Vcc, Black wire - Gnd, White wire - Data
//require 4.7K resistor between Vcc and Data line
...
#define BACHKHOA_LAT 10.77252
#define BACHKHOA_LONG 106.65837
...
#define PWM1 5 // PWM Pin 5, yellow line of the pump
#define PWM2 6 // PWM Pin 6, red line of the pump
...
// DallasTemperature sensorTemp(&ds);
...
//    ss.begin(9600); //SoftwareSerial begin ( for GPS ) Baud rate is 9600 (dont change this num)
    ...
    //sensorTemp.begin(); //Initialize DS18S20
}
